...
import com.jovita.mycustomarimagelabeling.java.common.DisplayRotationHelper
import com.jovita.mycustomarimagelabeling.java.common.samplerender.SampleRender
import com.jovita.mycustomarimagelabeling.java.common.samplerender.arcore.BackgroundRenderer
    ...
    if (objects != null) {
      ...
      ***************************************************************************************************/
      val anchorsTest =
        objects.mapNotNull { obj ->
          val anchor =
            createAnchor((obj.centerCoordinate.x)+50.toFloat(), (obj.centerCoordinate.y)+50.toFloat(), frame)
              ?: return@mapNotNull null
          Log.i(TAG, "Created anchor ${anchor.pose} from hit test")
